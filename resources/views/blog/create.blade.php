                    ...
                    <div class="col-xxl-8">
                        <div class="card custom-card">
                            <div class="card-body p-5">
                                <form style="font-family: 'Times New Roman', Times, serif; font-weight:bolder;" action="{{route('post.store')}}"  method="POST"  enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-xl-12">
                                            ...
                                            <div class="input-group">
                                                <input type="title" name="title" class="form-control form-control-lg @error('title') is-invalid @enderror" placeholder="enter title of blog post"/>
                                            </div>
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="input-group">
                                                <input type="author" name="author" class="form-control form-control-lg  @error('author') is-invalid @enderror" placeholder="enter name of author"/>
                                            </div>
                                        ...
                                        <div class="col-xl-12 mb-2">
                                            ...
                                            <textarea id="body" class="form-control input" style="height: 400px;" name="body"></textarea>
